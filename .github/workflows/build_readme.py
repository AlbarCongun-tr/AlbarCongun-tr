...
# Width must be wide enough for the longest line at size=21, or the
# text gets clipped. ~11.5px per character at this font size/weight,
# plus a safety margin, capped so it still fits narrow mobile viewports.
_longest_line_len = max(len(line) for line in cfg["typing_lines"])
typing_width = min(max(_longest_line_len * 12 + 40, 300), 700)
...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=21&pause=1000&color={theme['accent']}&center=true&vCenter=true&width={typing_width}&lines={typing_lines}" alt="Typing SVG" />
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username={user}&custom_title={urllib.parse.quote(cfg['display_name'])}%27s+Contribution+Graph&bg_color={theme['bg']}&color={theme['accent']}&line={theme['accent']}&point=FFFFFF&area=true&hide_border=true" alt="Activity Graph" width="100%"/>
